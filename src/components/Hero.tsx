  ...
  return (
    <section className="relative overflow-hidden py-16 lg:py-24 bg-cyber-grid-light bg-slate-50 border-b border-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* ── "New Community" origin badge ── */}
        <div className="flex justify-center mb-5">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-blue-200 text-xs font-semibold text-slate-700 shadow-sm">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight leading-tight text-slate-900 mb-6">
            Building Open Technology
            <br />
            <span className="text-gradient-blue">That Matters</span>
          </h1>

          <p className="text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed mb-4 font-normal">
            A new community — built from real experience in{' '}
            <strong className="text-slate-800 font-semibold">AI Systems</strong>,{' '}
            <strong className="text-slate-800 font-semibold">Cybersecurity</strong>,{' '}
            <strong className="text-slate-800 font-semibold">Cloud Engineering</strong>, and{' '}
            <strong className="text-slate-800 font-semibold">Open-Source Development</strong>.
          </p>

          {/* Honest "early stage" callout */}
          <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-xs font-semibold mb-8 shadow-sm">
            <Star className="w-3.5 h-3.5 text-amber-500 fill-amber-500" />
            <span>
              We're in our earliest days — come help shape something real from the ground up.
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-10">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 px-6 py-3.5 rounded-xl bg-white border border-slate-200 text-slate-800 hover:bg-slate-50 font-bold shadow-sm transition-all hover:scale-105"
            >
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 p-6 rounded-2xl bg-white border border-slate-200 shadow-md text-center">
          <div>
            ...
            <div className="text-xs font-mono text-slate-500 mt-1 uppercase font-semibold">
              Repos Goal
            </div>
          </div>
          <div>
            <div className="text-3xl sm:text-4xl font-extrabold text-blue-600">10k+</div>
            <div className="text-xs font-mono text-slate-500 mt-1 uppercase font-semibold">
              Community Goal
            </div>
          </div>
          ...
          <div>
            <div className="text-3xl sm:text-4xl font-extrabold text-emerald-600">Open</div>
            <div className="text-xs font-mono text-slate-500 mt-1 uppercase font-semibold">
              Always Free
            </div>
          </div>
